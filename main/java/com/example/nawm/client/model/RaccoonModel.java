package com.example.nawm.client.model;
...
public class RaccoonModel<T extends Raccoon> extends EntityModel<T> {
    ...
    public RaccoonModel() {
        ...
        head.setTextureOffset(20, 24).addBox(-4.0F, -3.0F, -2.0F, 6.0F, 6.0F, 4.0F, 0.0F, false);
        head.setTextureOffset(0, 0).addBox(0.0F, -5.0F, 0.0F, 2.0F, 2.0F, 1.0F, 0.0F, false);
        head.setTextureOffset(0, 0).addBox(-4.0F, -5.0F, 0.0F, 2.0F, 2.0F, 1.0F, 0.0F, false);
        head.setTextureOffset(23, 0).addBox(-2.5F, -0.02F, -5.0F, 3.0F, 3.0F, 4.0F, 0.0F, false);
        ...
        mane.setTextureOffset(0, 0).addBox(-5.0F, -3.0F, -3.0F, 8.0F, 6.0F, 7.0F, 0.0F, false);

        leg1 = new ModelRenderer(this);
        leg1.setRotationPoint(2.5F, 16.0F, 7.0F);
        leg1.setTextureOffset(0, 28).addBox(-2.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F, 0.0F, false);

        leg2 = new ModelRenderer(this);
        leg2.setRotationPoint(-0.5F, 16.0F, 7.0F);
        leg2.setTextureOffset(0, 28).addBox(-2.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F, 0.0F, false);

        leg3 = new ModelRenderer(this);
        leg3.setRotationPoint(2.5F, 16.0F, -4.0F);
        leg3.setTextureOffset(0, 28).addBox(-2.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F, 0.0F, false);
